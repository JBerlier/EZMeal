ce dossier contient:
	...
	-une version électronique du schéma conceptuel ORM complet (avec les contraintes d’unicité et rôles obligatoires, et avec une population représentative pour les relations les plus importantes);
...
les requêtes SQL que nous avons réalisées pour tester notre BDD (dont les requêtes demandées dans l'énoncé du TP4).
	-un petit rapport décrivant nos choix de conception.
