...
\begin{itemize}
	...
	\item Recette, ce champ n'est pas unique et obligatoire car nous pensons que c'est a chacun de decider s'il veut creer une recette ou non.%si on regarde les tableaus excels de Laurent il n'y a pas les 2 derniers ce qui est compréhenssible car le lien avec l'appréciation est mis dans le tableau appréciation et l'auteur de la recette est mis dans le tableau recette
\end{itemize}
...
\begin{itemize}
	...
	%dans ce tableau ci il est obligatoire non? comment on pourrait avoir une appréciation sans auteur?
	...
	%idem comment on pourrait avoir une appréciation si on ne sait sur quelle recette elle porte
